...
from keras.layers import Dense, regularizers, GRU, Activation, Dropout, Bidirectional, Masking
            ...
            if (not r'.' in ed):
                ...
                for fileName in files:
                    if (fileName[-3:] == 'wav'):
                        ...
                        # plt.plot(energy)
                        # plt.show()
                        # zrc = librosa.feature.zero_crossing_rate(y, frame_length = 1024, hop_length = 512, center = True)
...
model.add(Masking(mask_value=0.0, input_shape=(126,1)))

model.add(Bidirectional(GRU(256, init='glorot_uniform', inner_init='orthogonal',
                            activation='tanh',
...
model.add((GRU(400, init='glorot_uniform', inner_init='orthogonal',
               activation='tanh',
               inner_activation='hard_sigmoid', W_regularizer=regularizers.l2(0.0005),
               U_regularizer=regularizers.l2(0.0005), b_regularizer=regularizers.l2(0.005),
